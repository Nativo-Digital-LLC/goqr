				...
				<div className="max-w-[890px] w-full">
					...
					<div className="mb-[20px]">
						...
						<p className="ml-[18px]">
							...
							personal que los usuarios proporcionan al usar
							nuestro servicio.
						</p>
					</div>
					<div className="mb-[20px]">
						...
						<ul className="ml-[18px]">
							...
							<li className="mb-[5px]">Teléfono o WhatsApp</li>
							<li className="mb-[5px]">
					...
					<div className="mb-[20px]">
						...
						<ul className="ml-[18px]">
							<li className="mb-[5px]">
								Facilitar el inicio de sesión en la plataforma
							</li>
							<li className="mb-[5px]">
								Procesar la facturación y pagos
							</li>
							<li className="mb-[5px]">
								Enviar información de marketing y promociones
								relevantes
							</li>
						</ul>
					</div>
					<div className="mb-[20px]">
						...
						<p className="ml-[18px] mb-[5px]">
							Compartimos ciertos datos con proveedores externos
							para brindar un mejor servicio:
						</p>
						<ul className="ml-[18px]">
							<li className="mb-[5px]">
								<b className="font-[500]">UepaPay:</b>{" "}
								Compartimos el correo electrónico y número de
								WhatsApp para pagos con tarjeta.
							</li>
							<li className="mb-[5px]">
								<b className="font-[500]">Stripe:</b>{" "}
								Compartimos el correo electrónico para pagos con
								tarjeta.
							</li>
							<li className="mb-[5px]">
							...
							<li className="mb-[5px]">
								<b className="font-[500]">Meta Pixel:</b> Usado
								para seguimiento de campañas publicitarias, sin
					...
					<div className="mb-[20px]">
						...
						<ul className="ml-[18px]">
							...
							<li className="mb-[5px]">
								...
								contraseña, con opción de 2FA (autenticación de
								dos factores) o inicio de sesión con Google.
							</li>
						</ul>
					</div>
					<div className="mb-[20px]">
						...
						<ul className="ml-[18px]">
							...
							<li className="mb-[5px]">
								Solicitar la eliminación permanente de sus datos
						...
						<p className="ml-[18px]">
							Cualquier cambio en esta política de privacidad se
